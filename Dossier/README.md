...
Este directorio contiene los **reportes oficiales de pruebas** ejecutadas para el sistema **TrackLogic**, basado en **ESP32** y sensores biomédicos. El sistema está encargado de la adquisición y transmisión de datos fisiológicos.
...
Solo si estos criterios se cumplen, la prueba se clasifica como **✅ PASS**.
...
* **Integración funcional** entre sensores biomédicos (BPM, temperatura, aceleración).
